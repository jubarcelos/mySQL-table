...
CREATE TABLE SpotifyClone.albums(
  ...
  artist_id INT NOT NULL,
  year_inauguration YEAR NOT NULL,
...
INSERT INTO SpotifyClone.clients(client, age, plan_id, date_signature) VALUES
...
INSERT INTO SpotifyClone.followed(client_id, artist_id) VALUES
  (1, 6),
  (1, 2),
  (1, 3),
  (2, 6),
...
INSERT INTO SpotifyClone.albums(album, artist_id, year_inauguration) VALUES
  ('Envious', 6, 1990),
  ('Exuberant', 6, 1993),
...
INSERT INTO SpotifyClone.songs(album_id, song, duration) VALUES
  (1, 'Soul For Us', 200),
...
INSERT INTO SpotifyClone.historic(client_id, song_id, `date`) VALUES
